...
* OS X: [dockutil](https://github.com/kcrawford/dockutil), [Quick Look plugins](https://github.com/sindresorhus/quick-look-plugins)
...
### Clone with Git
    ...
    git clone https://github.com/JimSangwine/dotfiles.git
...
Alternatively, you can install this into `~/.dotfiles` remotely without Git using curl:
    ...
    sh -c "`curl -fsSL https://raw.github.com/JimSangwine/dotfiles/master/remote-install.sh`"
